...
class Matrix:
	...
	def matrix_file(self):
		...
		pheno_plots = fh.csv_reader(self.csv_file_dir+"ar_phenotype.csv")
		...
		if self.pheno_choose:
			for drug_name in self.pheno:
				try:
					...
					value = {}
					with open(self.csv_file_dir+"ar_phenotype.csv","r") as csvfile:
...
def main(install_directory,csvfile_directory):
	...
	if os.path.exists(mat.csv_file_dir+"ar_phenotype.csv"):
		mat.matrix_file()
